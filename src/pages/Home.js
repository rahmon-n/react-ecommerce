      ...
      <div className="sales">
        <div className="box__wrapper">
          <div className="box1">
            <div className="box1__item">
              ...
              <div className="products__img">
                <Link to={'products'}>
                  <img src="images/pic1.jpg" alt="watches" />
                </Link>
              </div>
            ...
            <div className="box1__item">
              ...
              <div className="products__img">
                <Link to={'products'}>
                  <img src="images/pic2.jpg" alt="watches" />
                </Link>
              </div>
              <div className="products__price">$499</div>
            </div>
          ...
          <div className="box2">
            <div className="box2__item">
              <div className="products__img">
                <Link to={'products'}>
                  <img src="images/pic3.jpg" alt="watches" />
                </Link>
              </div>
            ...
            <div className="box2__item">
              <div className="products__img">
                <Link to={'products'}>
                  <img src="images/pic4.jpg" alt="watches" />
                </Link>
              </div>
            ...
            <div className="box2__item">
              <div className="products__img">
                <Link to={'products'}>
                  <img src="images/pic5.jpg" alt="watches" />
                </Link>
              </div>
        ...
        <div className="box4">
          <div className="box4__item">
            ...
            <div className="products__img">
              <Link to={'products'}>
                <img src="images/pic9.jpg" alt="watches" />
              </Link>
            </div>
            <div className="products__price">$199</div>
          </div>
          <div className="box4__item">
            ...
            <div className="products__img">
              <Link to={'products'}>
                <img src="images/pic10.jpg" alt="watches" />
              </Link>
            </div>
